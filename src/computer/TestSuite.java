...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        Thread.sleep(500);
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Letterman");
        Thread.sleep(500);
        sendTextToElement(By.id("BillingNewAddress_Email"), "davidletterman@gmail.com");
        Thread.sleep(500);
        ...
        Thread.sleep(500);
        sendTextToElement(By.id("BillingNewAddress_Address1"), "123 Ashgrove Rd");
        Thread.sleep(500);
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "TW18 7HG");
        Thread.sleep(500);
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "01753 593236");
        Thread.sleep(500);
        ...
        sendTextToElement(By.id("CardholderName"), "MR D B LETTERMAN");
